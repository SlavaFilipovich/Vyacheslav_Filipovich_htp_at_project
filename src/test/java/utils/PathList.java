...
public class PathList {
    public static final String INSTALL_PROP = "src/test/resources/installation.properties";
    public static final String BOOKING_PROP = "src/test/resources/booking.properties";
    public static final String MY_EMAIL_PROP = "src/test/resources/my_email.properties";
